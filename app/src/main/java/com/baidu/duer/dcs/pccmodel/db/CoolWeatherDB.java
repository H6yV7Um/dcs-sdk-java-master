package com.baidu.duer.dcs.pccmodel.db;
...
/**
 * Created by kenway on 17/4/11 16:51
...
public class CoolWeatherDB {
    ...
    private CoolWeatherDB(Context context) {
        CoolWeatherOpenHelper helper = new CoolWeatherOpenHelper(context, DB_NAME, VERSION);
        db = helper.getWritableDatabase();//初始化数据库
    }
